...
Месячная аудитория составляет 50млн пользователей,месячный прирост картинок 60млн. 
Данные по хештегам пользователя должны обновляться постоянно, влияя на главную страницу. 
Возьмем среднее количество 10 хештегов для картинок - итого 600млн новых хештегов. 
Возьмем среднее количество 5 меняющихся хештегов для пользлователей - итого 250млн новых хештегов. 
Общая сумма хештегов - 850млн. Возьмем примерно 50 байт для одного тега, итого 3 Гб ОЗУ/месяц, 
тогда берем в одну БД 1Тб ОЗУ. Реплика сервера будет аналогична мастеру.
